...
const categories: Category[] = [
  {
    ...
    icon: Dumbbell,
    keywords: ["pool", "swim", "spa", "sauna", "steam", "gym", "fitness", "yoga", "massage", "jacuzzi", "hot tub", "sports", "tennis", "golf", "wellness"],
  },
  {
    id: "dining",
    label: "Dining & Drinks",
    icon: UtensilsCrossed,
    keywords: ["restaurant", "dining", "bar", "lounge", "cafe", "breakfast", "lunch", "dinner", "kitchen", "room service", "minibar", "mini bar", "snack", "beverage", "coffee", "tea"],
  },
  {
    id: "services",
    label: "Services",
    icon: ConciergeBell,
    keywords: ["concierge", "24/7", "front desk", "reception", "housekeeping", "laundry", "dry cleaning", "shuttle", "airport", "valet", "parking", "bell", "porter", "tour", "ticketing", "luggage", "wake-up", "newspaper"],
  },
  {
    id: "room",
    label: "Room Features",
    icon: Bed,
    keywords: ["air condition", "air conditioner", "air-conditioning", "ac", "non-ac", "tv", "television", "safe", "minibar", "mini bar", "refrigerator", "fridge", "balcony", "view", "bathrobe", "slipper", "toiletrie", "hair dryer", "iron", "desk", "workspace", "wardrobe", "closet", "soundproof", "blackout", "curtain", "heating", "fan", "telephone", "kitchenette", "microwave"],
  },
  {
    id: "connectivity",
    label: "Connectivity",
    icon: Wifi,
    keywords: ["wifi", "wi-fi", "internet", "business center", "meeting", "conference", "printer", "workspace"],
  },
  {
    id: "family",
    label: "Family & Accessibility",
    icon: Users,
    keywords: ["family", "kids", "children", "baby", "crib", "pet", "wheelchair", "accessible", "elevator", "lift", "stroller"],
  },
  {
    id: "safety",
    label: "Safety & Comfort",
    icon: ShieldIcon,
    keywords: ["security", "safe", "smoke", "fire", "alarm", "sprinkler", "first aid", "doctor", "cctv", "guard", "lock"],
  },
  {
    id: "other",
    label: "Other",
